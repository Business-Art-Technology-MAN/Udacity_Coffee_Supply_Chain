...
contract('SupplyChain', function(accounts) {
    ...
    it("Testing smart contract function harvestItem() that allows a farmer to harvest coffee", async() => {
        ...
        //https://knowledge.udacity.com/questions/36507
        // Changed this variable name to myEvent
        //var myEvent = supplyChain.events.Harvested() 
        //myEvent.on('data', (event) => {
        //    eventEmitted = true;
        //});
        // Mark an item as Harvested by calling function harvestItem()
        //uses library truffle-assertions
        ...
        // check the event emitted by supplyChain.harvestItem if "Harvested" event is found set eventEmitted = true
    ...
    it("Testing smart contract function packItem() that allows a farmer to pack coffee", async() => {
        ...
        truffleAssert.eventEmitted(tx, 'Packed', (ev) => {
         ...
         // Verify the result set
         assert.equal(resultBufferTwo[5], 2, 'Error: Invalid item packItem failed')
    ...
    it("Testing smart contract function sellItem() that allows a farmer to sell coffee", async() => {
        ...
        truffleAssert.eventEmitted(tx, 'ForSale', (ev) => {
         ...
         // Verify the result set
         assert.equal(resultBufferTwo[5], 3, 'Error: Invalid item sellItem failed')
         assert.equal(resultBufferTwo[4], productPrice, 'Error: Invalid item sellItem failed')
    ...
    it("Testing smart contract function shipItem() that allows a distributor to ship coffee", async() => {
        ...
        // Verify the result set
        assert.equal(resultBufferTwo[5], 5, 'Error: Invalid item shipkItem failed')
    ...
    it("Testing smart contract function receiveItem() that allows a retailer to mark coffee received", async() => {
        ...
        // Mark an item as Sold by calling function receivedItem()
    ...
    it("Testing smart contract function purchaseItem() that allows a consumer to purchase coffee", async() => {
        ...
        // Mark an item as Sold by calling function purchasedItem()
